...
public interface Java8Visitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link Java8Parser#ifCondition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitIfCondition(Java8Parser.IfConditionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link Java8Parser#whileCondition}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitWhileCondition(Java8Parser.WhileConditionContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link Java8Parser#forExpression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitForExpression(Java8Parser.ForExpressionContext ctx);
	/**
